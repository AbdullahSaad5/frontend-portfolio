...
**Personal frontend portfolio built with TypeScript.**
...
[View the deployed project](https://frontend-portfolio-one-flax.vercel.app)
...
components/  # reusable UI or application components
